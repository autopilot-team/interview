...
import {
	...
	SheetHeader,
	SheetTitle,
} from "@autopilot/ui/components/sheet";
import { Skeleton } from "@autopilot/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipProvider,
	TooltipTrigger,
} from "@autopilot/ui/components/tooltip";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: biome can't handle this
...
function SidebarTrigger({
	...
	return (
		<Button
			...
			variant="ghost"
			size="icon"
			className={cn("size-7 mr-0.75", className)}
			onClick={(event) => {
				onClick?.(event);
				toggleSidebar();
			}}
