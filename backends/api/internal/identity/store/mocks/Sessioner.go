...
func (_m *MockSessioner) Create(ctx context.Context, session *model.Session) (*model.Session, error) {
...
func (_c *MockSessioner_Create_Call) RunAndReturn(run func(context.Context, *model.Session) (*model.Session, error)) *MockSessioner_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
// InvalidateByID provides a mock function with given fields: ctx, id, userID
func (_m *MockSessioner) InvalidateByID(ctx context.Context, id string, userID string) error {
...
// InvalidateByUserID provides a mock function with given fields: ctx, userID, token
func (_m *MockSessioner) InvalidateByUserID(ctx context.Context, userID string, token string) error {
...
func (_c *MockSessioner_InvalidateByUserID_Call) RunAndReturn(run func(context.Context, string, string) error) *MockSessioner_InvalidateByUserID_Call {
	_c.Call.Return(run)
	return _c
}

// ListByUser provides a mock function with given fields: ctx, userID
func (_m *MockSessioner) ListByUser(ctx context.Context, userID string) ([]*model.Session, error) {
...
func (_c *MockSessioner_ListByUser_Call) Return(_a0 []*model.Session, _a1 error) *MockSessioner_ListByUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSessioner_ListByUser_Call) RunAndReturn(run func(context.Context, string) ([]*model.Session, error)) *MockSessioner_ListByUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSessioner) WithQuerier(q core.Querier) store.Sessioner {
	ret := _m.Called(q)
	...
	if rf, ok := ret.Get(0).(func(core.Querier) store.Sessioner); ok {
		r0 = rf(q)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockSessioner_WithQuerier_Call) Return(_a0 store.Sessioner) *MockSessioner_WithQuerier_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSessioner_WithQuerier_Call) RunAndReturn(run func(core.Querier) store.Sessioner) *MockSessioner_WithQuerier_Call {
	_c.Call.Return(run)
	return _c
}
